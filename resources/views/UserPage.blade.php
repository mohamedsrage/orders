...
@section('content')
    <div class="container" dir="rtl">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header text-center"> القائمه</div>
                    <div class="card-body text-right">
                        <form action="" method="get">
                            <a class="list-group-item list-group-item-action" href="/home">الصغحه الرئيسيه</a>
                            @foreach ( $cats as $row )
                ...
                <div class="card">
                    <div class="card-header text-center"> الطلبات السابقه</div>
                    <div class="card-body text-right">
                        <form action="" method="get">
                            <a class="list-group-item list-group-item-action" href="/order/show"> اظهار الطلبات السابقه</a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <a href="{{ route('meal_deatails', $meal->id) }}" class="btn btn-success" style="font-size: 16px" title="Add Cart">
                                <i class="fa fa-bell-slash-0" style="font-size: 16px;color: white"> اطلب الان
